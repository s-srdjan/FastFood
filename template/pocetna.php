<div class="welcome">
  <a href="./index.php?action=page&page=pocetna"><p><span id="text-front-pg">BN FAST FOOD</span> <i class="fas fa-hamburger" style="font-size:50px;color:orange"></i> </p></a>
  <?php if($user === 'admin'): ?>
  ...
  <?php else: ?>
    <p>Poruči <span style="font-style:italic; color:orange;">ONLINE</span> </p>
